...
import (
	...
	"github.com/Deet42/iodinecoin-full/docs"
...
func New(
	...
	*/
	...
	app.IodinecoinfullKeeper = *iodinecoinfullmodulekeeper.NewKeeper(
		appCodec,
		keys[iodinecoinfullmoduletypes.StoreKey],
		keys[iodinecoinfullmoduletypes.MemStoreKey],
		app.GetSubspace(iodinecoinfullmoduletypes.ModuleName),
	)
